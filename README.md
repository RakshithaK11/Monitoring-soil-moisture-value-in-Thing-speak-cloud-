...
const char ssid[] = "Rakshitha";
const char pass[] = "00000000";

int keyIndex = 0;
WiFiClient  client;

unsigned long myChannelNumber =  3121446;
const int ChannelField = 1; 
const char * myWriteAPIKey = "7TT62SD1RI9O7TAS";
...
~~~
# CIRCUIT DIAGRAM:
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/bb336600-0187-45fb-8fc0-d1dcc39f56ee" />

# OUTPUT:
<img width="1919" height="974" alt="image" src="https://github.com/user-attachments/assets/6fa88c2c-e0ef-4759-964f-edcc50018462" />
<img width="1211" height="675" alt="image" src="https://github.com/user-attachments/assets/4f8ea5f0-9f14-4e73-8a87-8837003773d3" />
